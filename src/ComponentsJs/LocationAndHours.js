  ...
  return (
    <div className={styles.locationAndHours} id="locationAndHours">
      ...
      <div className={styles.locationAndHoursInfo}>
        ...
        <p>
          <Link
            to="https://www.google.com/maps?cid=12748043516579285804"
            target="_blank"
          >
            3 Mitchell Place (49th & 1st Avenue),
          </Link>
        </p>
        <p>
          <Link
        ...
        <p>
          <Link to="tel:+212.980.4796">Contact Number</Link>
        </p>
        ...
        <p>
          <span>Monday - Wednesday:</span> 5pm - 11pm
        </p>
        <p>
          <span>Thursday:</span> 5pm - 12am
        </p>
        <p>
          <span>Friday:</span> - Saturday: 5pm - 2am
        </p>
        <p>
          <span>Sunday:</span> 5pm - 11pm
        </p>
        {height > 700 ? <img src={Img1}></img> : null}
        <p>
          Send us a message and we'll get back to you as soon as possible
          Info@Opheliany.com. You can also reach us by phone at{" "}
