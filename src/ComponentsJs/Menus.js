  ...
  return (
    <div ref={ref} className={MenusCSS.menus} id="menus">
      ...
      <nav>
        <ul>
          <motion.li
            className={MenusCSS[number === 1 ? "highlited" : null]}
            onClick={() => setNumber(1)}
          >
            Cuisine
          </motion.li>
          <motion.li
            animate={animation1}
            className={MenusCSS[number === 2 ? "highlited" : null]}
            onClick={() => setNumber(2)}
          >
            Sweets
          </motion.li>
          <motion.li
            animate={animation2}
            className={MenusCSS[number === 3 ? "highlited" : null]}
            onClick={() => setNumber(3)}
          >
            Cocktails
          </motion.li>
          <motion.li
            animate={animation3}
            className={MenusCSS[number === 4 ? "highlited" : null]}
            onClick={() => setNumber(4)}
          >
            Wine
          </motion.li>
          <motion.li
            animate={animation4}
            className={MenusCSS[number === 5 ? "highlited" : null]}
            onClick={() => setNumber(5)}
          >
            Beer
          </motion.li>
