  ...
  return (
    <div className={VideosCSS.videos} id="videos">
      <motion.img
        ...
        className={VideosCSS.video1}
        src={OpheliaSnowGlobInTheSky}
        alt=""
      ></motion.img>
      <Link
        className={VideosCSS.reservationLink}
        to="https://www.opentable.com/restref/client/?rid=995113&restref=995113&datetime=2022-11-15T23%3A00&covers=1&rtype=ism&searchdatetime=2022-11-15T23%3A00&partysize=1&lang=en&corrid=1012cffb-09d7-4c7f-8c88-32b9990ed919"
        target="_blank"
      >
        Reservations
      </Link>
      ...
      <Link
        to="https://www.youtube.com/channel/UC1jMXPz34KvewKeJ-kf8-vA"
        target="_blank"
      >
        <button className={VideosCSS.subscribeBtn}>
          Subscribe to Ophelia's YouTube Channel
        </button>
      </Link>
      <motion.img
        className={VideosCSS.zodiacImg}
        ref={ref1}
        animate={animation1}
        src="https://images.getbento.com/accounts/0dc3afa185c13d245b6a95eba90422e9/media/images/ophelia-zodiac-dj-ad-v1-2019.gif?w=1000&fit=max&auto=compress,format&h=1000"
        alt=""
      ></motion.img>
