  ...
  return (
    <div ref={ref} className={HistoryCss.history} id="history">
      ...
      <motion.div animate={animation1} className={HistoryCss.text}>
        ...
        <p>
          Ophelia sits a top of this esteemed monument of classic New York
          architecture, designed by John Mead Howells and featuring sculptures
          by Rene Paul Chambellan.
        </p>
        <p>
          Muse for New Yorkers, including one time regular - Frank Sinatra. Now
          it's yours to enjoy.
        </p>
        <p>
